...
namespace MAD
{
    public partial class Form12 : Form
    {
        ...
        public Form12(string _usser, int _ID)
        {
            usser = _usser;
            ID = _ID;
            InitializeComponent();
        ...
        private void desbloquearCuentaToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void desbloquearCuentaToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            Thread th = new Thread(NewForm);
            th.SetApartmentState(ApartmentState.STA);
            th.Start();
        ...
        {
            Application.Run(new Form15(usser, ID));
        }
